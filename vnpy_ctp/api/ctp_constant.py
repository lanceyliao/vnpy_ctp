THOST_FTDC_EXP_Normal = '0'  # THOST=Trader Host；FTDC=Futures Trading Data Center（CTP常量前缀）；EXP=Exchange Property
THOST_FTDC_EXP_GenOrderByTrade = '1'
THOST_FTDC_ICT_EID = '0'  # ICT=Id Card Type（证件类型）
...
THOST_FTDC_IR_All = '1'  # IR=Investor Range（投资者范围）
THOST_FTDC_IR_Group = '2'
THOST_FTDC_IR_Single = '3'
THOST_FTDC_DR_All = '1'  # DR=Department Range（部门范围）
THOST_FTDC_DR_Group = '2'
THOST_FTDC_DR_Single = '3'
THOST_FTDC_DS_Asynchronous = '1'  # DS=Data Sync Status（数据同步状态）
THOST_FTDC_DS_Synchronizing = '2'
THOST_FTDC_DS_Synchronized = '3'
THOST_FTDC_BDS_Synchronized = '1'  # BDS=Broker Data Sync（经纪商数据同步状态）
THOST_FTDC_BDS_Synchronizing = '2'
THOST_FTDC_ECS_NoConnection = '1'  # ECS=Exchange Connect Status（交易所连接状态）
THOST_FTDC_ECS_QryInstrumentSent = '2'
THOST_FTDC_ECS_GotInformation = '9'
THOST_FTDC_TCS_NotConnected = '1'  # TCS=Trader Connect Status（交易连接状态）
THOST_FTDC_TCS_Connected = '2'
THOST_FTDC_TCS_QryInstrumentSent = '3'
THOST_FTDC_TCS_SubPrivateFlow = '4'
THOST_FTDC_FC_DataAsync = '1'  # FC=Function Code（功能码）
...
THOST_FTDC_BFC_ForceUserLogout = '1'  # BFC=Broker Function Code（经纪商功能码）
...
THOST_FTDC_OAS_Submitted = 'a'  # OAS=Order Action Status（报单操作状态）
THOST_FTDC_OAS_Accepted = 'b'
THOST_FTDC_OAS_Rejected = 'c'
THOST_FTDC_OST_AllTraded = '0'  # OST=Order Status（报单状态）
...
THOST_FTDC_OSS_InsertSubmitted = '0'  # OSS=Order Submit Status（报单提交状态）
...
THOST_FTDC_PSD_Today = '1'  # PSD=Position Date（持仓日期）
THOST_FTDC_PSD_History = '2'
THOST_FTDC_PDT_UseHistory = '1'  # PDT=Position Date Type（持仓日期类型）
THOST_FTDC_PDT_NoUseHistory = '2'
THOST_FTDC_ER_Broker = '1'  # ER=Exchange Role（交易所角色）
THOST_FTDC_ER_Host = '2'
THOST_FTDC_ER_Maker = '3'
THOST_FTDC_PC_Futures = '1'  # PC=Product Class（产品类别）
...
THOST_FTDC_PC_TAS = '7'
THOST_FTDC_PC_MI = 'I'
THOST_FTDC_APC_FutureSingle = '1'  # APC=Apply Product Class（适用产品类别）
...
THOST_FTDC_IP_NotStart = '0'  # IP=InstLifePhase（合约生命周期状态）
THOST_FTDC_IP_Started = '1'
THOST_FTDC_IP_Pause = '2'
THOST_FTDC_IP_Expired = '3'
THOST_FTDC_D_Buy = '0'  # D=Direction（买卖方向）
THOST_FTDC_D_Sell = '1'
THOST_FTDC_PT_Net = '1'  # PT=Position Type（持仓类型）
THOST_FTDC_PT_Gross = '2'
THOST_FTDC_PD_Net = '1'  # PD=PosiDirection（持仓方向）
